...
class GaugeReader:
    ...
    def __connect(self):
        ...
        try:
            self.__ser.open() #This has to be modified!
    ...
    def __disconnect(self):
        ...
        try:
            ...
            if status:
                ...
                print("Gauge reader at port "+self.__ser.port+" cannot be closed")
        except SerialException:
    ...
    def read(self):
        ...
        if not connectionStatus: 
            print("Cannot establish connection to port "+self.__ser.port)
            self.__disconnect()
            return None
        else:
